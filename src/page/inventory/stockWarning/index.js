...
export default class StockWarning extends React.Component{
    constructor(props) {
        super(props);
                ...
                orderFooter.validateFields((ferr,fvalue)=> {
                    if(!ferr){
                        ...
                        fetch('/purchasing/storage',{
                            ...
                            credentials:'include',
                            mode:"cors",
                            body:JSON.stringify(Object.assign(order,{IRmark:'其他入库'}))
                        }).then(
                            res=>res.json()
                        ).then(data=>{
                            ...
                            this.setState({
                                ...
                                proInfos.forEach((item)=>{
                                    ...
                                    fetch('/houseDetail',{
                                        ...
                                        credentials:'include',
                                        mode:"cors",
                                        body:JSON.stringify(Object.assign(proInfo,{IRmark:'其他入库'}))
                                    });
                                    fetch('/stock',{
                                        method:'POST',
                                        headers:{
        ...
        return(
            <Row className="order">
                <Row className="header">
                    <Col span={12} className="title">其他入库</Col>
