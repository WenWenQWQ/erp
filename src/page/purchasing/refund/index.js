...
export default class BuyOrder extends React.Component{
    constructor(props) {
        super(props);
    ...
    handleSubmit=()=>{
        ...
        orderHeader.validateFields((err,value)=>{
            if(!err) {
                let orderDate = moment(value.orderDate).format("YYYY-MM-DD");
        ...
        return(
            <Row className="buyOrder">
                <Row className="header">
                    <Col span={12} className="title">采购退货单</Col>
                       ...
                       <Form.Item label="供应商">
                           {
                               getFieldDecorator("supplier",{
                                   ...
                                   this.renderSupplier(this.props.supplierList)
                               )
                           }
                       </Form.Item>
                       <Form.Item label="退货人员">
                           {
                               getFieldDecorator("buyer",{
                                   rules:[{
                                       required:true,message:'请输入采购人员'
                                   }]
                               })(
                                   <Input/>
                               )
    ...
    onBlur=()=>{
        this.props.form.validateFields((err,value)=>{
           this.props.form.setFieldsValue({
               "discountAmount":value.discountRate*this.props.amountRate,
               "actualAmount":this.props.amountRate-value.discountRate*this.props.amountRate
           })
        })
    }
    render(){
