...
export default class SaleDelivery extends React.Component{
    constructor(props) {
        super(props);
                ...
                orderFooter.validateFields((ferr,fvalue)=> {
                    if(!ferr){
                        ...
                        fetch('/sale/delivery',{
                            ...
                            credentials:'include',
                            mode:"cors",
                            body:JSON.stringify(Object.assign(order,{IRmark:'销售出库'}))
                        }).then(
                            res=>res.json()
                        ).then(data=>{
                            ...
                            this.setState({
                                ...
                                proInfos.forEach((item)=>{
                                    ...
                                    fetch('/deliveryDetail',{
                                        ...
                                        credentials:'include',
                                        mode:"cors",
                                        body:JSON.stringify(Object.assign(proInfo,{IRmark:'销售出库'}))
                                    });
                                    fetch('/stock',{
                                        method:'POST',
                                        headers:{
        ...
        return(
            <Row className="order">
                <Row className="header">
                    <Col span={12} className="title">销售出库</Col>
