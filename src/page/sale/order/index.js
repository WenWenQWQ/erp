                            ...
                            this.setState({
                                ...
                                proInfos.forEach((item)=>{
                                    ...
                                    fetch('/saleOrderDetail',{
                                        ...
                                        credentials:'include',
                                        mode:"cors",
                                        body:JSON.stringify(Object.assign(proInfo,{IRmark:'销售订单'}))
                                    })
                                })
                            })
                        }).catch(function (err) {
        ...
        return(
            <Row className="buyOrder">
                <Row className="header">
                    <Col span={12} className="title">销售订单</Col>
                ...
                <Row className="body">
                    <Col className="body-header">
                        <FilterForm
                            ...
                            customerList={this.state.customer}
                        />
                    </Col>
                       ...
                       <Form.Item label="客户">
                           {
                               getFieldDecorator("customer",{
                                   ...
                                   this.renderCustomer(this.props.customerList)
                               )
                           }
                       </Form.Item>
